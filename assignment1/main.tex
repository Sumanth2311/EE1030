...
\item(a) Only one solution\item(b) Only two solutions\item(c) Infinite number of solutions\item(d) None of these.
\end{enumerate}
\end{multicols}
...
\begin{multicols}{2}
\begin{enumerate}
\item max$\brak{p,q}<$max$\brak{p,q}$\item min$\brak{p,q}$=$\frac{1}{2}$$\brak{p+q}$\item max$\brak{p,q}<$min$\brak{p,q,r}$\item  none of these
\end{enumerate}
\end{multicols}
...
\begin{enumerate}
[label=, left=0pt, labelsep=0pt, itemsep=1em]
\item(a) no root\item(b) one root\item(c) two equal roots\item(d) infinitely many roots 
\end{enumerate}
\end{multicols}
