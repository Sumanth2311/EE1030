...
\begin{alignat}{2}
AB&=B-A&=\vec{(1 - (-1), -2 - 2, 5 - 1)}&=\vec{(2, -4, 4)}\\
BC&=C-B&=\vec{(4 - 1, -7 - (-2), 8 - 5)}&=\vec{(3, -5, 3)}\\
CD&=D-C&=\vec{(2 - 4, -3 - (-7), 4 - 8)}&=\vec{(-2,4,-4)}\\
DA&=A-D&=\vec{(-1 - 2, 2 - (-3), 1 - 4)}&=\vec{(-3, 5, -3)} 
\end{alignat}

Verify if $AB$ is equal to $ CD $ and $ BC $ is equal to $ DA $:
\begin{alignat}{2}
AB+CD&=\vec{(2, -4, 4)}+\vec{(-2, 4, -4)}&=\vec{(0, 0, 0)}\\
BC+DA&=\vec{(3, -5, 3)}+\vec{(-3, 5, -3)}&=\vec{(0, 0, 0)}
\end{alignat}
